...
const ERROR_MESSAGES = {
    ...
    unsupported_format: 'Подключение не поддерживает выбранный формат JSON. Выберите Auto или JSON по инструкции.',
    json_mode_custom_only: 'JSON mode доступен для прямого Custom API. Для этого подключения выберите Auto, JSON Schema или JSON по инструкции.',
    request_budget: 'Достигнут лимит дополнительных запросов. Попробуйте другой режим JSON или повторите генерацию.',
    empty_options: 'Модель вернула пустой набор вариантов. Исправлять нечего; повторите генерацию.',
};
